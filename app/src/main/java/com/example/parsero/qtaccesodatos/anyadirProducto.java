...
public class anyadirProducto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAñadirProducto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                anyadirProducto(nombre, descripcion, categoria, precio, id);
    ...
    public void anyadirProducto(String nombre, String descripcion, String categoria, String precio, String id) {
